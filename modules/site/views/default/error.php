...
WebErrorAsset::register($this);
?>

<div class="site-error">
    <div class="row">
        <div class="col-md-6 offset-md-3 col-12 mt-1">
            <div class="card mb-4 mb-lg-0">
                <div class="card-body p-5 text-center">
                    ...
                    <p class="mb-0">
                        Please contact us if you think this is a server error. Thank you. <span class="fof">&nbsp;</span>
                    </p>
                </div>
            </div>
        </div>
